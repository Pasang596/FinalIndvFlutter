...
class AppointmentSalonDetailsScreen extends StatefulWidget {
  const AppointmentSalonDetailsScreen({Key? key}) : super(key: key);

  @override
  State<AppointmentSalonDetailsScreen> createState() =>
      _AppointmentSalonDetailsScreenState();
}

class _AppointmentSalonDetailsScreenState
    extends State<AppointmentSalonDetailsScreen> {
                          ...
                          InkWell(
                            onTap: () {
                              ...
                              if (_globalKey.currentState!.validate() &&
                                  appointmentFor != null) {
                                BookSalonAppointment bookSalonAppointment =
                                    BookSalonAppointment(
                                        ...
                                        salonId: appointment[0],
                                        price: appointment[1]);
                                _bookSalonAppointment(bookSalonAppointment);
                              }
                            },
                            child: Container(
                              decoration: BoxDecoration(
  ...
  _bookSalonAppointment(BookSalonAppointment booksalonAppointment) async {
    bool isBooked =
        await CategoryRepository().bookSalonAppointment(booksalonAppointment);
