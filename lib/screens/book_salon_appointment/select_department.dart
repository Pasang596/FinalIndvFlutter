...
class SalonDepartmentScreen extends StatefulWidget {
  const SalonDepartmentScreen({Key? key}) : super(key: key);

  @override
  State<SalonDepartmentScreen> createState() => _SalonDepartmentScreenState();
}

class _SalonDepartmentScreenState extends State<SalonDepartmentScreen> {
          ...
          child: Padding(
            ...
            child: Column(
              children: [
                ...
                const SizedBox(height: 15),
                FutureBuilder<List<NailsCategory?>>(
                  future: CategoryRepository().loadNailsCategory(),
                      ...
                      return SizedBox(
                        ...
                        child: GridView.builder(
                          ...
                          itemBuilder: (BuildContext context, int index) {
                            return InkWell(
                              onTap: () {
                                Navigator.pushNamed(context, "/searchSalon",
                                    arguments: [
