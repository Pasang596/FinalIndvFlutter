        ...
        child: Padding(
          ...
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              InkWell(
                onTap: () {
                  Navigator.pushReplacementNamed(context, '/salonGoogleMap');
                },
                child: Container(
                        ...
                        children: [
                          Expanded(
                            ...
                            child: Container(
                              ...
                              // width: width * 0.56,
                              child: const Text(
                                "Remember to always regularly check up your nails with us",
                                style: TextStyle(
                                    fontSize: 20,
                                    color: Colors.white,
