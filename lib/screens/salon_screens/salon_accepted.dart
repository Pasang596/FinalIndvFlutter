...
class SalonAcceptedPage extends StatefulWidget {
  const SalonAcceptedPage({Key? key}) : super(key: key);
  @override
  State<SalonAcceptedPage> createState() => _SalonAcceptedPageState();
}

class _SalonAcceptedPageState extends State<SalonAcceptedPage> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<GetSalonUIAppointment?>>(
                  future:
                      CategoryRepository().getSalonUIAppointment("Accepted"),
                  builder: (context, snapshot) {
                    if (snapshot.hasData) {
                      ...
                      // debugPrint(
                      //     "data Apt salon: " + snapshot.data.toString());
  ...
  Widget scheduleContainer(GetSalonUIAppointment? appointmentResponse) {
    return Padding(
  ...
  endAppointment(GetSalonUIAppointment appointmentResponse) async {
    // debugPrint("Appointment ID: " + appointmentResponse.id!);
    bool isAccepted = await CategoryRepository()
        .updateSalonUIAppointment(appointmentResponse.id!, "Ended");
    if (isAccepted) {
