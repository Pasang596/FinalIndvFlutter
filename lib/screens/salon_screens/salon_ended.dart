...
class SalonEndedPage extends StatefulWidget {
  const SalonEndedPage({Key? key}) : super(key: key);

  @override
  State<SalonEndedPage> createState() => _SalonEndedPageState();
}

class _SalonEndedPageState extends State<SalonEndedPage> {
  @override
            ...
            child: Column(
              ...
              children: [
                ...
                FutureBuilder<List<GetSalonUIAppointment?>>(
                  future: CategoryRepository().getSalonUIAppointment("Ended"),
